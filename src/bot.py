...
<b>Silver</b> - дает право размещать 10 объявлений.Цена: 2000тг.
<b>Gold</b> - дает право размещать 30 объявлений.Цена: 5000тг.
<b>Platinum</b> - дает право размещать 50 объявлений.Цена: 8000тг.
