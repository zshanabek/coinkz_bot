...
<b>Silver</b> - дает право размещать 10 объявлений.Цена: <br>2000тг</br>.
<b>Gold</b> - дает право размещать 30 объявлений.Цена: <br>5000тг</br>.
<b>Platinum</b> - дает право размещать 50 объявлений.Цена: <br>8000тг</br>.
